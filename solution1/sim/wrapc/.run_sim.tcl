...
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.4/win64/tools/fpo_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.4/win64/tools/opencv"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.4/win64/tools/fft_v9_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.4/win64/tools/fir_v7_0"
set ::env(PATH) "$::env(PATH);C:/Xilinx/Vivado_HLS/2016.4/win64/tools/dds_v6_0"
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "xor_bit.autotvin.dat"
	set constFileTvOut       "xor_bit.autotvout.dat"
	set constFileHdlTvIn     "xor_bit.autohdltvin.dat"
	set constFileHdlTvOut    "xor_bit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
