...
$(ObjDir)/xorBit_test.c_pre.c.tb.o : xorBit_test.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) xorBit_test.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/xorBit.c_pre.c.tb.o : xorBit.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) xorBit.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
