; ModuleID = 'C:/Users/Linda/Documents/AK_1_CS_FerlindaFeliana_HLS/solution1/.autopilot/db/a.g.1.bc'
...
define void @xor_bit(i4 zeroext %in1, i4 zeroext %in2, i4* %out) nounwind {
  ...
  call void @llvm.dbg.value(metadata !{i4 %in1}, i64 0, metadata !21), !dbg !22 ; [debug line = 3:20] [debug variable = in1]
  call void @llvm.dbg.value(metadata !{i4 %in2}, i64 0, metadata !23), !dbg !24 ; [debug line = 3:31] [debug variable = in2]
  call void @llvm.dbg.value(metadata !{i4* %out}, i64 0, metadata !25), !dbg !26 ; [debug line = 3:43] [debug variable = out]
  %out.assign = xor i4 %in2, %in1, !dbg !27       ; [#uses=1 type=i4] [debug line = 4:2]
  store i4 %out.assign, i4* %out, align 1, !dbg !27 ; [debug line = 4:2]
