...
HD_PWD='C:/Users/Linda/Documents/AK_1_CS_FerlindaFeliana_HLS/solution1/impl/vhdl/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xor_bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xor_bit.tcl
