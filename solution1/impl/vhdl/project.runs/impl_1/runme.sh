...
HD_PWD='C:/Users/Linda/Documents/AK_1_CS_FerlindaFeliana_HLS/solution1/impl/vhdl/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xor_bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xor_bit.tcl -notrace
